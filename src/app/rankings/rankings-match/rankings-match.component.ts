...
export class RankingsMatchComponent implements OnInit {
  ...
  get matchround() {
    return this.matchForm.get('matchround');
  }
  get group() {
    return this.matchForm.get('group');
  }
  get matchday() {
    return this.matchForm.get('matchday');
  }
  get team1() {
    return this.matchForm.get('team1');
  }
  get team2() {
    return this.matchForm.get('team2');
  }
  get goals1() {
    return this.matchForm.get('goals1');
  }
  get goals2() {
    return this.matchForm.get('goals2');
  }
  get penalties1() {
    return this.matchForm.get('penalties1');
  }
  get penalties2() {
    return this.matchForm.get('penalties2');
  }
  ...
  fillTournamentsByConfederation = (val) => {
    ...
    this.tournamentService
      .getAllByTournamentTypeAndConfederation(this.selectedTournamentType, val)
      .subscribe((res) => {
        this.tournaments = res;
      });
  };
  ...
  onSubmit = () => {
    ...
    this.rankingService.add(newMatch).subscribe(() => {
      this.resetMatch();
