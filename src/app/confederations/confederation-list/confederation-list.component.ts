...
export class ConfederationListComponent implements OnInit {
  ...
  onDelete = (id) => this.confederationService.delete(id).subscribe(this.getAllConfederations);

  getAllConfederations = () => this.confederationService.getAll().subscribe((res) => this.confederations = res);
}
