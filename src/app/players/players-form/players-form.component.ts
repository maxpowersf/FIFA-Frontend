...
export class PlayersFormComponent implements OnInit {
  ...
  get dorsal() { return this.playerForm.get('dorsal') };
  get team() { return this.playerForm.get('team'); }
  get confederationsGoals() { return this.playerForm.get('confederationsGoals'); }
  get worldCupGoals() { return this.playerForm.get('worldCupGoals'); }
  get confederationsGoldenBoots() { return this.playerForm.get('confederationsGoldenBoots'); }
  ...
  ngOnInit() {
    ...
    if (this.isEditing) {
      ...
      this.confederationsGoldenBoots.patchValue(this.player.confederationsGoldenBoots);
  ...
  onSubmit = () => {
    ...
    playerModified.confederationsGoldenBoots = this.confederationsGoldenBoots.value;
    playerModified.worldCupGoldenBoots = this.worldCupGoldenBoots.value;

    this.isEditing
      ? this.playerService.update(playerModified)
        .subscribe(this.goToList)
      : this.playerService.add(playerModified)
        .subscribe(this.goToList);
  }
